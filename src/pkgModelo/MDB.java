...
public class MDB {
	...
	protected Conexion conexion;
        ...
        conexion = new Conexion("com.mysql.jdbc.Driver",  "jdbc:mysql://localhost:3306/bddatos?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&useTimezone=true&serverTimezone=GMT&useSSL=false", "root","manu123");//ESTA CADENA LARGA SE USA PARA MAC Y PARA ALGUNAS INSTALACIONES RECIENTES DE MYSQL
